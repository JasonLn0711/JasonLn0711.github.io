...
relations:
  - slug: speech-evidence-pipelines
    type: extends
    reason: "The recent-work overview connects speech evidence principles to the speech and voice systems described here."
    reasonZh: "近期工作總覽將語音證據原則連到文中整理的語音與聲音系統。"
  - slug: flat-ui-to-spatial-interface
    type: related
    reason: "The interface essay offers a reading companion for the overview's voice systems and AI workflow interfaces."
    reasonZh: "介面文章可搭配總覽中的聲音系統與 AI 工作流程閱讀，理解使用者如何操作這些能力。"
---
