...
series: evidence-aware-ai
order: 3
relations:
  - slug: speech-evidence-pipelines
    type: related
    reason: "Both essays examine how to preserve evidence for review; this one adds disclosure constraints across nodes."
    reasonZh: "兩篇都關注可檢視的證據；本文再加入跨節點協作時的資訊揭露條件。"
---
